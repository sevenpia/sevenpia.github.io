$(document).ready(function () {
    ...
    /*
        ...
        모바일에서는 hover, mouseenter, mouseover 모두 click  의 형태로 표현된다. 
        떠날 때는          mouseleave, mouseout 사용
    */
...
//    탭메뉴
    ...
    $(".contents section.con2 img").stop().animate({"top":"0px"}, 1000);
    $(".contents section.con3 ul.baro li").stop().animate({"top":"0px"}, 1300);
